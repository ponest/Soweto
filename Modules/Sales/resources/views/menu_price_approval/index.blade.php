...
@section('title','Item Price Approval')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-9" style="padding-top: 2vh">
                    <h5 class="font-strong">MENU PRICE APPROVAL REQUEST</h5>
                </div>
    ...
    @include('sales::menu_price_approval.create')
