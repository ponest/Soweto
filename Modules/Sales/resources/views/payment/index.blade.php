        ...
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-3" style="padding-top: 2vh">
                    <h5 class="font-strong">PAYMENT HISTORY</h5>
                </div>
                <div class="col-9" style="text-align: right">
                    <!--Buttons Goes Here-->
                    <form autocomplete="off" method="post" action="{{route('payment-history-filter')}}">
                        @csrf
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-3" style="text-align: left">
                                ...
                                @if($is_post_back)
                                    <a href="{{route('payment-history-excel')}}"  class="btn btn-primary">Excel</a>
                                @endif
                            </div>
                        </div>
                    </form>
