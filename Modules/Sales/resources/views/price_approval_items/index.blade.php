...
@section('content')
        ...
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-8" style="padding-top: 2vh">
                    <h5 class="font-strong">{{$price_approval->request_number}} - PRICE APPROVAL ITEMS</h5>
                </div>
                <div class="col-4" style="text-align: right">
                    @if($type == "request")
                        <a href="{{route('item-price-approval.index')}}" class="btn btn-primary">
    ...
    @include('sales::price_approval_items.create')
