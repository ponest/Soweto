...
@section('title','Disposal Request Items')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-8" style="padding-top: 2vh">
                    <h5 class="font-strong">{{$requisition->request_number}} - STOCK DISPOSAL REQUEST ITEMS</h5>
                </div>
                <div class="col-4" style="text-align: right">
                    <a href="{{route('disposal-request.index')}}" class="btn btn-primary">
    ...
    @include('inventory::disposal_request_items.create')
