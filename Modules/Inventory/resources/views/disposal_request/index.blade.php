...
@section('title','Disposal Request')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
    ...
    @include('inventory::disposal_request.create')
