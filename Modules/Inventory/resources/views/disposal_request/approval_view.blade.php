...
@section('title','Stock Disposal Request')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-9" style="padding-top: 2vh">
                    <h5 class="font-strong">STOCK DISPOSAL REQUEST</h5>
                </div>
                        ...
                        <tr>
                            ...
                            <td style="width: 9%" class="text-center">
                                ...
                                @can('Director')
                                    @if($item->approved_by ==null)
                                        | <a class="text-muted font-16 approve-link"
                                             href="{{route('disposal-request.approve',$item->id)}}"
                                ...
                                | <a class="text-muted font-16 reject-link"
                                     href="{{route('disposal-request.reject-view',$item->id)}}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="create_modal">Stock Disposal Request Items</h5>
