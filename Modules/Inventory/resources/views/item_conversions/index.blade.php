...
@section('content')
        ...
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-9" style="padding-top: 2vh">
                    <h5 class="font-strong">UNIT CONVERSION</h5>
                </div>
                ...
                <table class="table table-bordered table-hover table-sm" id="datatable">
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>{{isset($item->fromUnit) ? $item->fromUnit->name : 'Not Defined'}}</td>
                            <td>{{isset($item->toUnit) ? $item->toUnit->name : 'Not Defined'}}</td>
                            <td>{{$item->multiplier}}</td>
                            <td style="width: 9%" class="text-center">
                                <a class="text-muted font-16 edit-link" href="{{route('unit-conversion.edit',$item->id)}}"
                                   title="Edit" data-toggle="tooltip"><i class="fa fa-edit"></i></a> |
                                <a class="text-muted font-16 delete-link"
                                   href="{{route('unit-conversion.destroy',$item->id)}}"
    ...
    @include('inventory::item_conversions.create')
