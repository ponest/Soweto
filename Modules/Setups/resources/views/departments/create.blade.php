        ...
        <div class="modal-content">
            <form action="{{route('departments.store')}}" method="post" autocomplete="off">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="create_modal">Create Department</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" name="name" class="form-control form-control-air" placeholder="Department Name" required>
                        </div>
                    </div>
                </div>
