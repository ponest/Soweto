...
@section('content')
        ...
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-9" style="padding-top: 2vh">
                    <h5 class="font-strong">IDENTITY TYPES</h5>
                </div>
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td style="width: 9%" class="text-center">
                                <a class="text-muted font-16 edit-link" href="{{route('identity-types.edit',$item->id)}}"
                                   title="Edit" data-toggle="tooltip"><i class="fa fa-edit"></i></a> |
                                <a class="text-muted font-16 delete-link" href="{{route('identity-types.destroy',$item->id)}}"
    ...
    @include('setups::identity_types.create')
