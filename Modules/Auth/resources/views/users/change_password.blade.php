...
<div class="ibox login-content">
    ...
    <form class="ibox-body" id="login-form" action="{{route('change-password')}}" method="POST">
        @csrf
        ...
        <div class="text-center mb-4">
            ...
            {{--            <a href="{{route('users.index')}}" class="btn btn-primary btn-rounded btn-block">LOGIN</a>--}}
        </div>
        <div class="text-center mb-4">
            @if ($errors->any())
                @foreach ($errors->all() as $error)
                    <span class="text-muted" style="color: red !important;">{{$error}}</span> <br/>
                @endforeach
            @endif
