...
@section('title','Kitchen Transaction Request')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-9" style="padding-top: 2vh">
                    <h5 class="font-strong">KITCHEN TRANSACTION REQUEST</h5>
                </div>
                            ...
                            <td style="width: 12%" class="text-center">
                                @if(!$item->submitted_at)
                                    <a class="text-muted font-16 edit-link"
                                       href="{{route('kitchen-trans-req.edit',$item->id)}}"
                                       title="Edit" data-toggle="tooltip"><i class="fa fx-2 fa-edit"></i></a> |
                                    <a class="text-muted font-16 delete-link"
                                       href="{{route('kitchen-trans-req.destroy',$item->id)}}"
                                       title="Delete" data-toggle="tooltip"><i class="fa fx-2 fa-trash-o"></i></a>
                                    <a class="text-muted font-16"
                                       href="{{route('kitchen-trans-item.index',$item->id)}}"
                                       title="Items" data-toggle="tooltip"><i class="fa fx-2 fa-bars"></i></a>
                                @endif
                                @if(!$item->submitted_at)
                                    | <a class="text-muted font-16 submit-link"
                                         href="{{route('kitchen-trans-req.submit',$item->id)}}"
    ...
    @include('general::kitchen_trans_req.create')
