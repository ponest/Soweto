<form action="{{route('stock-backlog-item.update',$item)}}" method="post" autocomplete="off">
    @csrf
    @method('PUT')
    ...
    <div class="modal-body">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="number" name="quantity" class="form-control form-control-air" value="{{$item->quantity}}" required>
            </div>
            <div class="col">
                <label>Unit</label>
