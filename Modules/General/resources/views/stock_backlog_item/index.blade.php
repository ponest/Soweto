...
@section('title','Stock Backlog Items')
@section('content')
    <div class="ibox">
        <div class="ibox-body">
            ...
            <div class="row">
                <div class="col-8" style="padding-top: 2vh">
                    <h5 class="font-strong">{{$requisition->request_number}} - STOCK BACKLOG ITEMS</h5>
                </div>
                <div class="col-4" style="text-align: right">
                    <a href="{{route('stock-backlog.index')}}" class="btn btn-primary">
    ...
    @include('general::stock_backlog_item.create')
