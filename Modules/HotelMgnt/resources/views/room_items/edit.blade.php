<form action="{{route('room-items.update',$item->id)}}" method="post" autocomplete="off">
    @csrf
    @method('PUT')
    ...
    <div class="modal-body">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="text" name="quantity" value="{{$item->quantity}}" class="form-control form-control-air" required>
            </div>
        </div>
    </div>
