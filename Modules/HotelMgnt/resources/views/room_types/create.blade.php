<div class="modal fade" id="create_modal" tabindex="-1" aria-labelledby="create_modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('room-types.store')}}" method="post" autocomplete="off">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="create_modal">Create Room Type</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <textarea name="description" class="form-control form-control-air" placeholder="Description" required></textarea>
                        </div>
                    </div>
                </div>
