...
class DailyStockReport implements FromView,WithEvents
{
...
//                $sales = count(session('items_data'));
//                $count = $sales + 3;

//                $event->sheet->getStyle('A'.$count.':H'.$count)->applyFromArray($styleArray);
    ...
    public function view(): View
    {
        ...
        return view('reports::stock_sheet.excel', $params);
    }
}
